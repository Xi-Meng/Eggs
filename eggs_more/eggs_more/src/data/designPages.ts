...
export const designPages: DesignPageMeta[] = [
  ...
  { id: 'oJi', title: '主页', routePath: '/design/oJi' },
  { id: 'Kkt', title: '设备页', routePath: '/design/Kkt' },
  { id: '88P', title: '设备关', routePath: '/design/88P' },
  { id: 'a7b', title: '厨房空气质量检测', routePath: '/design/a7b' },
  { id: 'KKk', title: '厨房空气质量检测开', routePath: '/design/KKk' },
  { id: 'W4y', title: '厨房空气质量检测差', routePath: '/design/W4y' },
  { id: 'MYI', title: '厨房空气质量检测差开', routePath: '/design/MYI' },
  { id: 'Ynv', title: '厨房空气质量检测差开1', routePath: '/design/Ynv' },
  ...
  { id: 'tAa', title: '咸了吗总页面', routePath: '/design/tAa' },
  { id: 'ytA95', title: '咸了吗总页面', routePath: '/design/ytA95' },
  { id: 'rlB', title: '咸了吗开始', routePath: '/design/rlB' },
  { id: 'a9b', title: '咸了吗结束', routePath: '/design/a9b' },
  { id: 'AnX', title: '咸了吗1开始', routePath: '/design/AnX' },
  { id: 'wXj', title: '咸了吗1结束', routePath: '/design/wXj' },
  { id: 'UwB', title: '咸了吗2开始', routePath: '/design/UwB' },
  { id: '_aX', title: '咸了吗2结束', routePath: '/design/_aX' },
  { id: '4Ej', title: '结算', routePath: '/design/4Ej' },
  ...
  { id: 'MTDir', title: '结算', routePath: '/design/MTDir' },
